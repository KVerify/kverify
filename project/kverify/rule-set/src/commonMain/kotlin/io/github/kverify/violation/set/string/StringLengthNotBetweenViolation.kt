...
public data class StringLengthNotBetweenViolation(
    val value: String,
    val minLength: Int,
    val maxLength: Int,
    ...
    override val reason: String =
        run {
            ...
            "$displayName must NOT have a length between $minLength and $maxLength (inclusive), but its length is ${value.length}."
        },
) : Violation {
    public constructor(
        value: String,
