...
import io.github.kverify.violation.set.string.StringMatchesViolation

public open class StringMatchesViolationFactory(
...
public open class NamedStringMatchesViolationFactory(
    public val regex: Regex,
